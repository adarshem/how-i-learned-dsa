...
// Mock implementation of isBadVersion for demonstration purposes
function isBadVersion(version: number): boolean {
  const bad = 4; // Example bad version
  return version >= bad;
}
...
console.log(firstBadVersion(100)); // Output: 4